                ...
                <?php foreach ( $attributes as $attribute_name => $options ) : ?>
                    ...
                    if ( end( $attribute_keys ) === $attribute_name ): ?>
                        <tr>
                            <td class="label">&nbsp;</td>
                            <td class="value">
                                <?php echo wp_kses_post( apply_filters( 'woocommerce_reset_variations_link', '<button class="reset_variations"  aria-label="' . esc_html__( 'Clear options', 'teespace' ) . '">' . esc_html__( 'Clear options', 'teespace' ) . '</button>' ) ); ?>
                            </td>
                        </tr>
                    <?php endif; ?>
